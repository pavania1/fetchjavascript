...
//     v.onload = function() {
//         if (v.status === 200) {
//             var responseData = JSON.parse(v.responseText);
//             callback(null, responseData);
//         }else {
//             callback('Error: ' + v.status, null);
//         }
//     };
//     v.send();
// }
...
//             editPost(post.id);
//             idCell.innerHTML = '<input type="text" value="' +post.id + '">';
//             userIdCell.innerHTML = '<input type = "text" value="' +post.userId + '">';
//             titleCell.innerHTML = '<input type = "text" value="' +post.title + '">';
//             bodyCell.innerHTML = '<input type = "text" value="' +post.body +'">'; 
//         });
...
// // function is defined about the getPostById.....
...
//     xhr.open('POST','https://jsonplaceholder.typicode.com/posts', true,true);
//     xhr.setRequestHeader('Content-Type', 'application/json');
//     xhr.onload = function() {
//         if (xhr.status === 201) {
//             var createdPost =JSON.parse(xhr.responseText);
//             console.log('Created Post:', createdPost);
//             displayNewPost(createdPost);
//             resetCreatePostForm();
//         }else {
...
//     console.log(typeof postId);
//     if (Posts.filter(x=>x.id === parseInt(postId)).length>0) {
//         Posts = Posts.filter((x)=>x.id !== parseInt(postId));
//         displayPosts(Posts);
//     }else {
